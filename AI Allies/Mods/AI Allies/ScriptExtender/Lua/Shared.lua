...
----------------------------------------------------------------------------------
-- Performance Optimization: Cache player list
...
function Shared.GetAllPlayers()
    ...
    playerCache = players
    playerCacheTimer = currentTime
    return players
end

--- Clear the player cache (call when party composition changes)
...
Shared.STATUS = {
    ...
    -- Formation statuses
    FORMATION_FRONTLINE = "FORMATION_FRONTLINE",
    FORMATION_MIDLINE = "FORMATION_MIDLINE",
    FORMATION_BACKLINE = "FORMATION_BACKLINE",
    FORMATION_SCATTERED = "FORMATION_SCATTERED",
